...
public sealed class PoeNinjaService
{
    ...
    private static void InitPoe2Lists()
    {
        ...
        {
            // net8 compat: List.AddRange(params T[]) overload is net9+, wrap in array.
            ItemsTwo.AddRange(new NinjaItemTwo[] {
        ...
        {
            ExchangeTwo.AddRange(new NinjaExchange[] {
    ...
    private static void InitPoe1Lists()
    {
        ...
        {
            // net8 compat: List.AddRange(params T[]) overload is net9+, wrap in array.
            ItemsOne.AddRange(new NinjaItem[] {
        ...
        {
            ExchangeOne.AddRange(new NinjaExchange[] {
